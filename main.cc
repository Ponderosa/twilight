...
public:
    ...
    void blit() noexcept {
        ...
        //SDL_LockTexture(_texture, nullptr, data.pixelData, int(data.stride));
...
public:
    ...
    void onRender() noexcept override {
        ...
        BLGradient radial(BLRadialGradientValues(512, 512, 0, 512, 512));
        radial.addStop(0.0, BLRgba32(0xFFFFFFFF));
        radial.addStop(1.0, BLRgba32(0xFF1F7FFF));

        BLPath path;
        //path.moveTo(119, 49);
        //path.cubicTo(259, 29, 99, 279, 275, 267);
        //path.cubicTo(537, 245, 300, -170, 274, 430);
        //path.arcTo(256, 256, 100, 100, 0 * (M_PI / 180.0), 45 * (M_PI / 180));
        //path.arcTo(256, 256, 100, 100, 90 * (M_PI / 180.0), 135 * (M_PI / 180));
        ...
        // ctx.fillGeometry(BL_GEOMETRY_TYPE_PIE, &arc);
...
// Tunnel
// ============================================================================
// class Tunnel : public SDL_Application{
// public:
//   double pRot;
//   int numArc;
//   int blacking;
